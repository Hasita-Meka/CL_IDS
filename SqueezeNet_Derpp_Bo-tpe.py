...
auc_roc = roc_auc_score(all_labels, predictions, average='weighted', multi_class='ovr')
...
# Display time taken for the training and evaluation process
print(f'Time taken for training and evaluation: {time_taken:.2f} seconds')
